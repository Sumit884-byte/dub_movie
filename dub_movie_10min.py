...
OUTPUT = Path("movie_dubbed_10min_v7.mp4")
...
if __name__ == "__main__":
    dub_with_whisper_alignment(
        ...
        target_language="hi",
        duration=600,
        cache_path=Path("translated_segments_10min_v7.json"),
        chunks_dir=Path("temp_chunks_10min_v7"),
        workers=default_workers(),
        state_path=Path("movie_dubbed_10min_v7.state.json"),
        fresh=True,
